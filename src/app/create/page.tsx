        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          >
            ...
            <div className="p-4 bg-gray-900/50 border border-gray-800 rounded-xl">
              ...
              <h3 className="text-white font-medium mb-1">Use AI Assist</h3>
              <p className="text-sm text-gray-400">
                Visit the <Link href="/studio" className="text-green-400 hover:underline">Studio</Link> to generate descriptions and tokenomics with AI.
              </p>
            </div>
          </motion.div>
        </div>
